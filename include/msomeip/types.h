...
constexpr uint16_t SOMEIP_SD_METHOD_FIND_SERVICE = 0x0001;
constexpr uint16_t SOMEIP_SD_METHOD_OFFER_SERVICE = 0x0002;
constexpr uint16_t SOMEIP_SD_METHOD_SUBSCRIBE_EVENTGROUP = 0x0006;
constexpr uint16_t SOMEIP_SD_METHOD_SUBSCRIBE_EVENTGROUP_ACK = 0x0007;
constexpr uint16_t SOMEIP_SD_METHOD_SUBSCRIBE_EVENTGROUP_NACK = 0x0008;
